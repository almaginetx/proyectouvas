...
class Blog(models.Model):
    ...
    likes = models.IntegerField(blank=True, null=True, default=0, verbose_name="Likes")
    views = models.IntegerField(blank=True, null=True, default=0, verbose_name="views")
    user = models.ForeignKey(UserProfile, on_delete=models.CASCADE, blank=True, null=True, verbose_name="Usuario",related_name='blog_owner')
    create_at = models.DateTimeField(default=now, editable=False)
    update_at = models.DateTimeField(auto_now_add = False, auto_now=True, editable=False)
    slug = models.SlugField(editable=False)
...
class Config(models.Model):
    ...
    inkacoin = models.IntegerField(blank=True, null=True, default=0, verbose_name="Costo Inkacoin en $COP")
    minimo = models.IntegerField(blank=True, null=True, default=0, verbose_name="Costo Minimo Inkacoin en $COP")
    maximo = models.IntegerField(blank=True, null=True, default=0, verbose_name="Costo Maximo Inkacoin en $COP")
    create_at = models.DateTimeField(default=now, editable=False)
    update_at = models.DateTimeField(auto_now_add = False, auto_now=True, editable=False)
    slug = models.SlugField(editable=False)
